				...
				<section className="landing-hero-content animate-fade-in-up relative">
					<div className="landing-hero-copy-shell">
						...
						<div className="landing-copy-block">
							<p
								id="landing-tagline"
								className="landing-subtitle animate-fade-in-up delay-200"
							>
								<span className="landing-subtitle-line">
									Capture the ghost in the machine, discover the narrative.
								</span>
								<span className="landing-subtitle-line">
									A living trace of your intent, woven into every commit.
								</span>
							</p>
