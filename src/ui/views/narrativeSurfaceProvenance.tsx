			...
			<div className="grid gap-5 xl:grid-cols-[0.86fr_1.14fr]">
				<div className="space-y-4">
					...
					<div className="rounded-2xl border border-border-subtle bg-bg-primary p-4">
						...
						<p className="mt-2 text-sm leading-6 text-text-secondary">
							Observed facts land first, evidence joins come next, derived
							claims stay explicit, and the final node tells the operator
							whether to inspect or pause.
						</p>
						...
						return (
							<li key={`${node.eyebrow}-${node.title}`} className="relative">
								...
								<article
									...
									onKeyDown={(event) =>
										handleActionKeyDown(event, node.action, onAction)
									}
