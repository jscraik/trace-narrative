...
import type { SurfaceAction, NarrativeSurfaceViewModel, SurfaceMetric } from './narrativeSurfaceData';
...
export function LiveActivityArticle({
  ...
  activeSessionsMetric: SurfaceMetric & { authorityTier?: any; authorityLabel?: any };
...
export function LiveMonitorsArticle({
  ...
  viewModel: NarrativeSurfaceViewModel;
  captureModeMetric: SurfaceMetric & { authorityTier?: any; authorityLabel?: any };
  onAction?: (action: SurfaceAction) => void;
}) {
  return (
    <article
