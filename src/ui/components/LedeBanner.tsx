...
import type { SurfaceAuthorityCue, SurfaceMode } from '../views/narrativeSurfaceData';
...
export function LedeBanner({ mode, authorityTier, authorityLabel, heroTitle, heroBody, onJump }: LedeBannerProps) {
