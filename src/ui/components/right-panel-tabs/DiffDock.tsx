			...
			<div className="card flex-none overflow-hidden">
				<div className="w-full flex items-center gap-2 px-2 py-2 bg-bg-secondary text-xs font-medium text-text-secondary">
					<button
						...
						className="flex min-w-0 flex-1 items-center justify-between gap-3 rounded-md px-2 py-1 transition duration-200 ease-out active:duration-75 active:scale-[0.98] hover:bg-bg-hover outline-none focus-visible:ring-1 focus-visible:ring-accent-blue/30"
					>
						...
						<ChevronDown
							className={`h-3.5 w-3.5 transition-transform ${diffExpanded ? "" : "-rotate-90"}`}
						/>
					</button>
					<button
						type="button"
