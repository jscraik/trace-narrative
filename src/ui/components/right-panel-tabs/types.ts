...
export const TABS: TabConfig[] = [
  { id: 'session', label: 'Session', shortLabel: 'Session', iconName: 'message', category: 'analyze' },
  { id: 'attribution', label: 'AI Attribution', shortLabel: 'Attribution', iconName: 'activity', category: 'analyze' },
  { id: 'atlas', label: 'Atlas Search', shortLabel: 'Atlas', iconName: 'search', category: 'tools' },
  { id: 'tests', label: 'Tests', shortLabel: 'Tests', iconName: 'tests', category: 'tools' },
  { id: 'settings', label: 'Settings', shortLabel: 'Settings', iconName: 'settings', category: 'config' },
];
