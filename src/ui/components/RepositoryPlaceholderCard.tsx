...
export function RepositoryPlaceholderCard({
	...
	if (isDashboard) {
		message =
			"Open a repository to build a narrative brief from commits, evidence coverage, and Codex-linked sessions.";
	} else if (isDocs) {
		message =
			"Documentation will render once a repository with narrative docs is loaded into the workspace.";
	}
		...
		: isDocs
			...
			: [
					...
					},
					{
						title: "Link Sessions",
						detail:
							"Connect Codex sessions and other traces to concrete commits",
					},
				];
	...
	return (
		...
		>
			...
			<motion.p
				...
				transition={{
					duration: animations.waitingDuration,
					repeat: Infinity,
					ease: "easeInOut",
					delay: 1,
				}}
