 ...
 */
export function BranchSummaryBar({ model }: { model: BranchViewModel }) {
			...
			{model.narrative && (
				<>
					...
					<div className="flex items-center gap-1.5">
						<span
							className={`h-1.5 w-1.5 rounded-full ${model.narrative.confidence > 0.8 ? "bg-accent-green" : "bg-accent-amber"}`}
						/>
